...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules\\apollo-cache-control\\tsconfig.json";
...
<table cellpadding="0" cellspacing="0">
  ...
  <span class="hljs-attr">"compilerOptions"</span>: {
    ...
    <span class="hljs-attr">"lib"</span>: [<span class="hljs-string">"es2017"</span>, <span class="hljs-string">"esnext.asynciterable"</span>],
    <span class="hljs-attr">"types"</span>: [<span class="hljs-string">"jest"</span>, <span class="hljs-string">"node"</span>],
