...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules\\apollo-link-error\\tsconfig.json";
...
<table cellpadding="0" cellspacing="0">
  ...
  <a class="pilcrow" href="#section-1" id="section-1"></a>
        ...
        <td class="code highlight">
          <pre class="json">{
  <span class="hljs-attr">"extends"</span>: <span class="hljs-string">"../../tsconfig"</span>,
  ...
  <span class="hljs-attr">"exclude"</span>: [<span class="hljs-string">"src/**/__tests__/*.ts"</span>]
}
