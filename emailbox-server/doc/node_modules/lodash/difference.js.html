...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules\\lodash\\difference.js";
...
<table cellpadding="0" cellspacing="0">
  ...
  <a class="pilcrow" href="#section-1" id="section-1"></a>
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">var</span> baseDifference = <span class="hljs-built_in">require</span>(<span class="hljs-string">'./_baseDifference'</span>),
    baseFlatten = <span class="hljs-built_in">require</span>(<span class="hljs-string">'./_baseFlatten'</span>),
...
determined by the first array.</p>
</div>
<div class="body">
<p><strong>Note:</strong> Unlike <code>_.pullAll</code>, this method returns a new array.</p>
</div>
<div class="details">
...
<div class="dox_tag_detail">
<span class="dox_type">_.without, _.xor</span>
</div>
</div>
</div>
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">var</span> difference = baseRest(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">array, values</span>) </span>{
...
<span class="hljs-built_in">module</span>.exports = difference;
