...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules\\ms\\package.json";
...
<table cellpadding="0" cellspacing="0">
  ...
  <a class="pilcrow" href="#section-1" id="section-1"></a>
        ...
        <td class="code highlight">
          <pre class="json">{
  <span class="hljs-attr">"name"</span>: <span class="hljs-string">"ms"</span>,
  <span class="hljs-attr">"version"</span>: <span class="hljs-string">"2.0.0"</span>,
  <span class="hljs-attr">"description"</span>: <span class="hljs-string">"Tiny milisecond conversion utility"</span>,
  <span class="hljs-attr">"repository"</span>: <span class="hljs-string">"zeit/ms"</span>,
  ...
  <span class="hljs-attr">"scripts"</span>: {
    ...
    <span class="hljs-attr">"lint"</span>: <span class="hljs-string">"eslint lib/* bin/*"</span>,
    <span class="hljs-attr">"test"</span>: <span class="hljs-string">"mocha tests.js"</span>
  },
  ...
  <span class="hljs-attr">"devDependencies"</span>: {
    ...
    <span class="hljs-attr">"husky"</span>: <span class="hljs-string">"0.13.3"</span>,
    <span class="hljs-attr">"lint-staged"</span>: <span class="hljs-string">"3.4.1"</span>,
    <span class="hljs-attr">"mocha"</span>: <span class="hljs-string">"3.4.1"</span>
  }
}
