...
<html>
<head>
  <title>.zuul.yml</title>
  <meta http-equiv="content-type" content="text/html; charset=UTF-8">
  <link rel="stylesheet" media="all" href="../../doc-style.css" />
  <script src="../../doc-filelist.js"></script>
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules\\ieee754\\.zuul.yml";
...
<table cellpadding="0" cellspacing="0">
  ...
  <a class="pilcrow" href="#section-1" id="section-1"></a>
        ...
        <td class="code highlight">
          <pre class="yaml"><span class="hljs-attr">ui:</span> <span class="hljs-string">tape</span>
<span class="hljs-attr">scripts:</span>
<span class="hljs-bullet">  -</span> <span class="hljs-string">"./test/_polyfill.js"</span>
...
<span class="hljs-attr">    version:</span> <span class="hljs-string">latest</span>
<span class="hljs-attr">  - name:</span> <span class="hljs-string">ie</span>
<span class="hljs-attr">    version:</span> <span class="hljs-number">11</span>
<span class="hljs-attr">  - name:</span> <span class="hljs-string">microsoftedge</span>
<span class="hljs-attr">    version:</span> <span class="hljs-string">latest</span>
