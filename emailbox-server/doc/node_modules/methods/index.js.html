...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules\\methods\\index.js";
...
<div class="details">
        ...
        <td class="code highlight">
          <pre class="javascript">
<span class="hljs-built_in">module</span>.exports = getCurrentNodeMethods() || getBasicNodeMethods();
...
<div class="dox">
<div class="summary">
<p>Get the current Node.js methods.</p>
</div>
<div class="body">
</div>
<div class="details">
        ...
        <td class="code highlight">
          <pre class="javascript">
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">getCurrentNodeMethods</span>(<span class="hljs-params"></span>) </span>{
  <span class="hljs-keyword">return</span> http.METHODS &amp;&amp; http.METHODS.map(<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">lowerCaseMethod</span>(<span class="hljs-params">method</span>) </span>{
    <span class="hljs-keyword">return</span> method.toLowerCase();
  });
}
...
<div class="dox">
<div class="summary">
<p>Get the &quot;basic&quot; Node.js methods, a snapshot from Node.js 0.10.</p>
</div>
<div class="body">
</div>
<div class="details">
        ...
        <td class="code highlight">
          <pre class="javascript">
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">getBasicNodeMethods</span>(<span class="hljs-params"></span>) </span>{
