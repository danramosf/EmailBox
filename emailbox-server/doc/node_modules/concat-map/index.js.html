...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules\\concat-map\\index.js";
...
<table cellpadding="0" cellspacing="0">
  ...
  <a class="pilcrow" href="#section-1" id="section-1"></a>
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">xs, fn</span>) </span>{
    <span class="hljs-keyword">var</span> res = [];
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; xs.length; i++) {
        <span class="hljs-keyword">var</span> x = fn(xs[i], i);
        <span class="hljs-keyword">if</span> (isArray(x)) res.push.apply(res, x);
        <span class="hljs-keyword">else</span> res.push(x);
    }
