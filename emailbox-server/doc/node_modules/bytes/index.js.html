...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules\\bytes\\index.js";
...
<span class="hljs-keyword">var</span> map = {
  ...
  <span class="hljs-attr">tb</span>: ((<span class="hljs-number">1</span> &lt;&lt; <span class="hljs-number">30</span>) * <span class="hljs-number">1024</span>)
};

<span class="hljs-keyword">var</span> parseRegExp = <span class="hljs-regexp">/^((-|\+)?(\d+(?:\.\d+)?)) *(kb|mb|gb|tb)$/i</span>;
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">format</span>(<span class="hljs-params">value, options</span>) </span>{
  ...
  <span class="hljs-keyword">if</span> (!unit || !map[unit.toLowerCase()]) {
    <span class="hljs-keyword">if</span> (mag &gt;= map.tb) {
